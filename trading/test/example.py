...
stats_optimized = bt.optimize(n1=range(5, 30, 5),
                              n2=range(10, 70, 5),
...
# %%
bt.plot(plot_volume=False, plot_pl=False, open_browser=False)
...
# %%
print("\n--- Last 5 Rows of Stats (Optimized) ---")
print(stats_optimized.tail())

# %% [markdown]
# The columns should be self-explanatory.

# %%
print("\n--- Equity Curve (Optimized) ---")
print(stats_optimized['_equity_curve'])  # Contains equity/drawdown curves. DrawdownDuration is only defined at ends of DD periods.

# %%
print("\n--- Trades (Optimized) ---")
print(stats_optimized['_trades'])  # Contains individual trade data
